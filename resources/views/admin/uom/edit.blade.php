    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" action="{{ route('uom.update',['id'=>$uom->id]) }}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="name" id="uom_name" required placeholder="Name" value="{{$uom->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select2" id="uom_type" required name="type">
                                    <option value="reference" @if($uom->type == 'reference') selected @endif>Reference</option>
                                    <option value="biggerthan" @if($uom->type == 'biggerthan') selected @endif>Bigger Than</option>
                                    <option value="smallerthan" @if($uom->type == 'smallerthan') selected @endif>Smaller Than</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="ratio" id="uom_ratio" required placeholder="Ratio" value="{{$uom->ratio}}" >
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#uomcategory_id").select2('data',{id:{{$uom->uomcategory->id}},text:'{{$uom->uomcategory->name}}'}).trigger('change');

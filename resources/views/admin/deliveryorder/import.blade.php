...
@section('title', 'Import Delivery Order')
@section('stylesheets')
...
<li class="breadcrumb-item active">Import Delivery Order</li>
@endpush
@section('content')
<div class="row">
  <div class="col-lg-12">
    <div class="card card-{{ config('configs.app_theme') }} card-outline" id="attendance-preview">
      ...
      <div class="card-body">
        <form id="form" action="{{route('deliveryorder.storemass')}}">
        </form>
  ...
  $(function(){
      ...
      $("#form-import").validate({
          ...
          submitHandler: function() { 
              $.ajax({
                  url:"{{route('deliveryorder.preview')}}",
                  method:'post',
      ...
      $("#form").validate({
          ...
          submitHandler: function() { 
              ...
              $.ajax({
                  ...
                  data: {
                      _token: "{{ csrf_token() }}",
                      deliveryorders: JSON.stringify(deliveryorders)
                  },
                  beforeSend:function(){

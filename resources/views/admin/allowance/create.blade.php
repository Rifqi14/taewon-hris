...
@push('breadcrump')
<li class="breadcrumb-item"><a href="{{route('allowance.index')}}">{{ __('allowance.alw') }}</a></li>
<li class="breadcrumb-item active">{{ __('general.crt') }}</li>
@endpush


@section('content')
<form id="form" action="{{ route('allowance.store') }}" class="form-horizontal" method="post" autocomplete="off">
	{{ csrf_field() }}
	<div class="row px-2">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="{{ __('allowance.alwname') }}" id="allowance" name="allowance" required>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>{{ __('allowance.category') }}</label>
									<select name="category" id="category" class="form-control select2" style="width: 100%" aria-hidden="true" data-placeholder="{{ __('allowance.slctcategory') }}">
										<option value=""></option>
						...
						<div class="row account-section">
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="{{ __('allowance.account') }}" id="account" name="account">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>{{ __('allowance.recur') }}</label>
									<select name="recurrence" id="recurrence" class="form-control select2" style="width: 100%" aria-hidden="true" data-placeholder="{{ __('allowance.slcrecur') }}">
										<option value=""></option>
										<option value="hourly">{{ __('allowance.hourly') }}</option>
										<option value="daily">{{ __('allowance.daily') }}</option>
										<option value="monthly">{{ __('allowance.monthly') }}</option>
										<option value="yearly">{{ __('allowance.yearly') }}</option>
										<option value="breaktime">{{ __('allowance.breaktm') }}</option>
									</select>
								</div>
							</div>
						</div>
						<div class="row ">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="{{ __('general.chs') }} {{ __('groupallowance.grpalw') }}" id="groupallowance" name="groupallowance">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-sm-6 days-devisor-section d-none">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="days_devisor" name="days_devisor" placeholder="Days Devisor">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="notes" name="notes" placeholder="{{ __('general.notes') }}"></textarea>
							</div>
						</div>
					</div>

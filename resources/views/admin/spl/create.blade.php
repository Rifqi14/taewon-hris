					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="spl_date" id="spl_date" class="form-control datepicker" placeholder="{{ __('general.date') }}" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>{{ __('spl.startdt') }} <b class="text-danger">*</b></label>
								<input placeholder="{{ __('spl.startdt') }}" name="start_date" id="start_date" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>{{ __('spl.starttm') }} <b class="text-danger">*</b></label>
								<input placeholder="{{ __('spl.starttm') }}" name="start_time" id="start_time" class="form-control timepicker" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>{{ __('spl.fnshdate') }} <b class="text-danger">*</b></label>
								<input placeholder="{{ __('spl.fnshdate') }}" name="finish_date" id="finish_date" class="form-control" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>{{ __('spl.fnshtime') }} <b class="text-danger">*</b></label>
								<input placeholder="{{ __('spl.fnshtime') }}" name="finish_time" id="finish_time" class="form-control timepicker" />
							</div>
						</div>

...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-{{config('configs.app_theme')}} card-outline" id="asset-preview">
            ...
            <div class="card-body">
                <form id="form" action="{{route('asset.storemass')}}">
                </form>
        ...
        $("#form").validate({
          ...
          submitHandler: function() {
              ...
              $.ajax({
                  ...
                  beforeSend:function(){
                      $('#asset-preview .overlay').removeClass('d-none');
                  }
              }).done(function(response){
                  $('.overlay').addClass('d-none');
                  if(response.status){

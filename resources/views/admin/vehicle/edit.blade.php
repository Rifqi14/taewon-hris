        ...
        <form id="form" action="{{ route('vehicle.update',['id'=>$asset->id]) }}" class="form-horizontal" method="post"
            ...
            <div class="card card-{{config('configs.app_theme')}} card-outline">
                <div class="card-header">
                    <h3 class="card-title">Information Vecile</h3>
                    <!-- tools box -->
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="engine_no" name="engine_no" placeholder="Engine No"  value="{{ $asset->engine_no }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="license_no" class="col-sm-2 col-form-label">Plat Number <b class="text-danger">*</b></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <label for="type" class="col-sm-2 col-form-label">Type <b
                                class="text-danger">*</b></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="type" name="type" placeholder="Type" value="{{ $asset->type }}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="manufacture" class="col-sm-2 col-form-label">Manufacture <b
                                class="text-danger">*</b></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="manufacture" name="manufacture" placeholder="Manufacture" value="{{ $asset->manufacture }}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="engine_capacity" class="col-sm-2 col-form-label">Engine Capacity <b
                                class="text-danger">*</b></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="engine_capacity" name="engine_capacity" placeholder="Engine Capacity" value="{{ $asset->engine_capacity }}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="production_year" class="col-sm-2 col-form-label">Production Year <b
                                class="text-danger">*</b></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="production_year" name="production_year" placeholder="Production Year" value="{{ $asset->production_year }}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">

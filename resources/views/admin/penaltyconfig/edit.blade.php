...
@section('title', 'Edit Penalty Config')
@section('stylesheets')
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <textarea name="notes" id="notes" style="height: 120px" class="form-control" placeholder="Notes">{{ $penaltyConfig->notes }}</textarea>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <select name="status" id="status" class="form-control select2" data-placeholder="Select Status" required>
                  <option value="ACTIVE" @if ($penaltyConfig->status == 'ACTIVE') selected @endif>Active</option>
                  <option value="NON-ACTIVE" @if ($penaltyConfig->status == 'NON-ACTIVE') selected @endif>Non Active</option>
                </select>
              </div>
            </div>
          </div>

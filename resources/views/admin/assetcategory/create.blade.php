...
<div class="row">
    ...
    <div class="card card-{{config('configs.app_theme')}} card-outline">
        <div class="card-header">
          <h3 class="card-title">{{__('general.crt')}} {{__('assetcat.assetcat')}}</h3>
          <!-- tools box -->
        ...
        <div class="card-body">
            <form id="form" action="{{route('assetcategory.store')}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
               <div class="well well-sm">
                 <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">{{__('assetcat.parent')}}</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="parent_id" name="parent_id" data-placeholder="{{__('general.chs')}} {{__('assetcat.parent')}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">{{__('assetcat.namecat')}}<b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="name" name="name" placeholder="{{__('assetcat.namecat')}}" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">{{__('assetcat.tipecat')}}<b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                      {{-- <input type="text" class="form-control" id="type" name="type" placeholder="Category Type" required> --}}
                      <select name="type" id="type" class="form-control select2" placeholder="{{__('assetcat.tipecat')}}">
                        <option value=""></option>
                        <option value="asset">{{__('assetcat.asset')}}</option>
                        <option value="vehicle">{{__('assetcat.vehicle')}}</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="well well-sm">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <textarea name="description" id="description" class="form-control" placeholder="{{__('assetcat.desc')}}" required></textarea>
                    </div>
                  </div>
                  <div class="form-group row">

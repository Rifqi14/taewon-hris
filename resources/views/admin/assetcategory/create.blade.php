...
<div class="row">
    ...
    <div class="card card-{{config('configs.app_theme')}} card-outline">
        <div class="card-header">
          <h3 class="card-title">Create Asset Category</h3>
          <!-- tools box -->
            ...
            <form id="form" action="{{route('assetcategory.store')}}" class="form-horizontal" method="post" autocomplete="off">
               ...
               <div class="well well-sm">
                 <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="parent_id" name="parent_id" data-placeholder="Choose Category Parent">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">Category Type<b class="text-danger">*</b></label>
                    <div class="col-sm-6">

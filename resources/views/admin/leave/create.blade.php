...
@section('title', __('leave.addleave'))
@section('stylesheets')
        ...
        <div class="col-lg-12">
          <div class="card card-{{ config('configs.app_theme') }} card-outline">
            <div class="card-header">
              <div class="card-title">{{ __('employee.employ') }}</div>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{ __('employee.empname') }}" id="employee" name="employee" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{ __('position.pos') }}" id="title" name="title" readonly>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
          ...
          <div class="card card-{{ config('configs.app_theme')}} card-outline">
            <div class="card-header">
              ...
              <div class="pull-right card-tools">
                <a href="#" class="btn btn-{{ config('configs.app_theme')}} btn-sm text-white add_leave" data-toggle="tooltip" title="{{ __('general.add') }}" onclick="showList()">
                ...
                <table id="leave-list" class="table table-bordered table-striped">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th colspan="3" data-total_days="0">0 {{ __('leave.days') }}</th>
                    </tr>
                  </tfoot>
                </table>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="{{ __('leave.leavetp') }}" id="leave_type" name="leave_type" required>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                <label class="control-label" for="remaining">{{ __('leave.remain') }}</label>
                <input type="text" class="form-control" placeholder="{{ __('leave.remain') }}" id="remaining" name="remaining" readonly>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <textarea class="form-control" id="notes" name="notes" rows="5" placeholder="{{ __('general.notes') }}"></textarea>
              </div>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  function editLeave(that) {
		...
		$('#list-leave').find('.modal-title').html(`{{ __('general.edt') }} {{ __('general.date') }}`);

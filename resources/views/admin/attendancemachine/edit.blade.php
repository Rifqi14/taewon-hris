...
@section('title', 'Attendance Machine Edit')
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" name="deviceSN" id="deviceSN" class="form-control" placeholder="Device Serial Number" value="{{ $attendanceMachine->device_sn }}" required>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">

...
@section('title', 'Edit Daily Report Driver')
@section('stylesheets')
...
@section('content')
<form id="form" action="{{ route('dailyreportdriver.update', ['id'=>$dailyreportdriver->id]) }}" class="form-horizontal" method="post" autocomplete="off">
  <div class="row">
    <div class="col-lg-12">
          ...
          <div class="form-row">
            <div class="form-group col-sm-6">
              <div class="row">
                ...
                <div class="col-sm-8 controls">
                  <input type="text" class="form-control" id="code" name="code" value="{{ $dailyreportdriver->code }}">
                </div>
              </div>
            </div>
            <div class="form-group col-sm-6">
              <div class="row">
                ...
                <div class="col-sm-8 controls">
                  <div class="input-group">
                    ...
                    <input type="text" name="date" class="form-control datepicker" placeholder="Date" required value="{{ date('d/m/Y', strtotime($dailyreportdriver->date)) }}"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group col-sm-6">
              <div class="row">
                ...
                <div class="col-sm-8 controls">
                  <input type="text" id="police_no" name="police_no" class="form-control" placeholder="Police No" required value="{{ $dailyreportdriver->police_no }}"/>
                </div>
              </div>
            </div>
            <div class="form-group col-sm-6">
              <div class="row">
                ...
                <div class="col-sm-8 controls">
                  <input type="text" id="exp_passenger" name="exp_passenger" class="form-control" placeholder="Expedition/ Passenger" required value="{{ $dailyreportdriver->exp_passenger }}"/>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card card-{{ config('configs.app_theme') }} card-outline">
        ...
        <div class="card-body">
          <table class="table table-striped table-bordered datatable" id="table-product" style="width: 100%">
            ...
            <tbody>
              @foreach ($dailyreportdriver->dailyreportdriverdetail as $key => $item)
              <tr>
                ...
                <td class="p-1 text-center align-middle">
                  <div class="form-group mb-0">
                    ...
                    <input placeholder="Destination" name="destination[]" class="form-control form-control-sm" required value="{{$item->destination}}"/>
                  </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <input placeholder="Departure" name="departure[]" class="form-control form-control-sm text-center" required value="{{$item->departure}}"/>
                  <div class="input-group input-group-sm mb-0">
                    <div class="input-group-prepend">
                      <span class="input-group-text">Km</span>
                    </div>
                    <input placeholder="Value" name="departure_km[]" class="form-control form-control-sm currency text-right" required value="{{$item->departure_km}}"/>
                  </div>
                </td>
                <td class="p-1 text-right align-middle">
                    <input placeholder="Arrival" name="arrival[]" class="form-control form-control-sm text-center numberfield" required value="{{$item->arrival}}"/>
                    <div class="input-group input-group-sm mb-0">
                    <div class="input-group-prepend">
                      <span class="input-group-text">Km</span>
                    </div>
                    <input placeholder="Value" name="arrival_km[]" class="form-control form-control-sm currency text-right" required value="{{$item->arrival_km}}"/>
                  </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="input-group input-group-sm mb-0">
                  ...
                  <input placeholder="Value" name="parking[]" class="form-control form-control-sm currency text-right onCalculation" required  value="{{$item->parking}}"/>
                </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="input-group input-group-sm mb-0">
                  ...
                  <input placeholder="Value" name="toll_money[]" class="form-control form-control-sm currency text-right onCalculation" required  value="{{$item->toll_money}}"/>
                </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="input-group input-group-sm mb-0">
                  ...
                  <input placeholder="Value" name="oil[]" class="form-control form-control-sm currency text-right onCalculation" required  value="{{$item->oil}}"/>
                  </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="input-group input-group-sm mb-0">
                  ...
                  <input placeholder="Value" name="etc[]" class="form-control form-control-sm currency text-right onCalculation" required  value="{{$item->etc}}"/>
                  </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div></div>
                  ...
                  <input placeholder="Value" name="total[]" class="form-control form-control-sm currency text-right" required readonly value="{{$item->total}}">
                </div>
                </td>
            ...
            <input type="hidden" name="subtotal" class="form-control form-control-sm currency text-right"  value="{{ $dailyreportdriver->subtotal }}">
            <input type="hidden" name="subtotaladditional" class="form-control form-control-sm currency text-right"  value="{{ $dailyreportdriver->subtotaladditional }}">
            <input type="hidden" name="grandtotal" class="form-control form-control-sm currency text-right"  value="{{ $dailyreportdriver->grandtotal }}">
            <tfoot>
              <tr>
                ...
                <td class="text-right" data-subtotal>
                  {{number_format($dailyreportdriver->subtotal,0,',','.')}}
                </td>
                <td></td>
              </tr>
              <tr>
      ...
      <div class="card card-{{ config('configs.app_theme') }} card-outline">
        ...
        <div class="card-body">
          <table class="table table-striped table-bordered datatable" id="table-additional" style="width: 100%">
            ...
            <tbody>
              @foreach ($dailyreportdriver->dailyreportdriveradditional as $key => $item)
              <tr>
                <td class="text-center align-middle">
                  {{ $key + 1 }}
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="form-group mb-0">
                    ...
                    <input placeholder="Additional" name="additional_name[]" class="form-control form-control-sm" required value="{{$item->additional_name}}"/>
                  </div>
                </td>
                <td class="p-1 text-center align-middle">
                  <div class="input-group input-group-sm mb-0">
                  ...
                  <input placeholder="Value" name="additional_total[]" class="form-control form-control-sm currency text-right onCalculation" required value="{{$item->additional_total}}">
                </div>
                </td>
                <td class="text-center">
                  <a style="color: white;" class="btn btn-sm btn-danger remove" title="Remove"><i class="fa fa-minus-circle"></i></a>
            ...
            <tfoot>
              <tr>
                ...
                <td class="text-right" data-subtotaladditional="0">
                  {{number_format($dailyreportdriver->subtotaladditional,0,',','.')}}
                </td>
                <td></td>
              </tr>
              <tr>
                ...
                <td class="text-right" data-grandtotal="0">
                  {{number_format($dailyreportdriver->grandtotal,0,',','.')}}
                </td>
                <td></td>
              </tr>
              <tr>
...
<script>
  $(document).ready(function(){
    ...
    @if($dailyreportdriver->driver_id)
      $("#driver_id").select2('data',{id:{{$dailyreportdriver->driver_id}},text:'{{$dailyreportdriver->driver->name}}'}).trigger('change');
    @endif
    ...
    function addproduct() {
      ...
      var number = $('#table-product tr').length;
      var html = `<tr>
                <td class="text-center">
                  ${length}
                </td>
    ...
    function addAdditional() {
      var length = $('#table-additional tr').length - 3;

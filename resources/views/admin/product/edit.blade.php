    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <form id="form" action="{{ route('product.update',['id'=>$product->id]) }}" class="form-horizontal" method="post"
                    autocomplete="off">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <select id="type" name="type" class="form-control select2" placeholder="Pilih Tipe" required>
                                    <option value=""></option>
                                    <option value="standart" @if($product->type == 'standart') selected @endif>Standart</option>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-form-label">Nama Produk <b class="text-danger">*</b></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="productcategory_id" class="col-sm-2 col-form-label">Kategori Produk <b class="text-danger">*</b></label>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" id="productcategory_id" name="productcategory_id" data-placeholder="Pilih Kategori" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Produk Unggulan</label>
                                <div class="col-sm-4">
                                    <label> <input class="form-control" type="checkbox" name="best_product" @if($product->best_product)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 controls">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="weight" name="weight" value="{{ $product->weight }}" placeholder="Berat" required  />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 controls">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="volume_l" name="volume_l" value="{{ $product->volume_l }}" placeholder="L" required />
                                        <div class="input-group-append">
                                ...
                                <div class="col-sm-2 controls">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="volume_p" name="volume_p" value="{{ $product->volume_p }}" placeholder="P" required />
                                        <div class="input-group-append">
                                            <div class="input-group-text">cm</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-2 controls">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="volume_t" name="volume_t" placeholder="T" required value="{{ $product->volume_t }}"/>
                                        <div class="input-group-append">
                                            <div class="input-group-text">cm</div>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="condition" class="col-sm-2 col-form-label">Kondisi <b class="text-danger">*</b></label>
                                <div class="col-sm-6">
                                    <select id="condition" name="condition" class="form-control select2" placeholder="Pilih Kondisi" required>
                                        <option value=""></option>
                                        <option @if($product->condition == 'baru') selected @endif value="baru">Baru</option>
                                        <option @if($product->condition == 'bekas') selected @endif value="bekas">Bekas</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="uom_id" name="uom_id" data-placeholder="Pilih UOM" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="barcode" class="col-sm-2 col-form-label">barcode <b class="text-danger">*</b></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label for="minimum_qty" class="col-sm-2 col-form-label">Minimum Stock <b class="text-danger">*</b></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="minimum_qty" name="minimum_qty" placeholder="Minimum Stock"
                                        required value="{{ $product->minimum_qty }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function (){
        ...
        $("input[name=price], input[name=weight], input[name=volume_l], input[name=volume_p], input[name=volume_t]").inputmask('decimal', {
			rightAlign: false
		});
        ...
        $("#image").fileinput({
            ...
            initialPreview: '@foreach ($img as $item) <img src="{{asset($item)}}" class="kv-preview-data file-preview-image"> @endforeach',
            initialPreviewAsData: false,
            initialPreviewFileType: 'image',
            initialPreviewConfig: [
                {
                    caption: "@foreach ($img as $item) {{$item}} @endforeach",
                    downloadUrl: "@foreach ($img as $item) {{asset($item)}} @endforeach",
                    size:"@foreach ($img as $item) {{ File::size(public_path($item))}} @endforeach",
                    url: false
                }
            ],
            theme:'explorer-fas'
        ...
        $("#productcategory_id").select2('data', {

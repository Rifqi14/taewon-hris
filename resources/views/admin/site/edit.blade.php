          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="code" name="code" placeholder="Code" value="{{$site->code}}" minlength="3" maxlength="3" required>
                        <p class="help-block">Ex. M12 (Only letters  uppercase and digit input).</p>
                </div>
                <div class="form-group">
                  <label for="name">Name <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{$site->name}}" required>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" value="{{$site->phone}}" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="postal_code">Postal Code <b class="text-danger">*</b></label>
                    <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="Postal Code" value="{{$site->postal_code}}" required>
                </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="receipt_footer">Foot Notes </label>

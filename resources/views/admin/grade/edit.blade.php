		                                ...
		                                <div class="row">
		                                    <div class="col-sm-4">
		                                        <select class="form-control select2" name="min_duration" id="min_duration">
		                                            <option value="yes" @if($grade->min_duration == 'yes') selected @endif>Yes
		                                            </option>
		                                            <option value="no" @if($grade->min_duration == 'no') selected @endif>No
		                                            </option>
		                                        </select>
		                                    </div>
		                                    <div class="col-sm-8">
		                                        <input type="number" id="month" name="month" class="form-control"
		                                            value="{{ $grade->month }}" placeholder="Month" @if($grade->min_duration == 'no') readonly @endif>
		                                    </div>
		                                </div>
		                            </div>
		                        </div>
		                    ...
		                    <div class="row">
		                        ...
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                ...
		                                <input type="text" name="basic_umk_value" class="form-control" readonly=""
		                                    placeholder="Basic UMK Value" value="{{ $grade->basic_umk_value }}">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="row">
		                        ...
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                ...
		                                <input type="text" id="additional_value" class="form-control"
		                                    placeholder="Additional Value" name="additional_value"
		                                    value="{{ $grade->additional_value }}">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="row">
		                        <div class="col-sm-12">
		                            ...
		                            <div class="form-group">
		                                ...
		                                <input type="text" class="form-control" placeholder="Total Basic Salary"
		                                    name="basic_sallary" value="{{ $grade->basic_sallary }}" readonly="">
		                            </div>
		                        </div>
		                    </div>
		            </div>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="form-group">
							<label>Notes</label>
							<textarea class="form-control" style="height: 100px;" name="notes" placeholder="Notes">{{ $grade->notes }}</textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<select class="form-control select2" id="status" name="status" data-placeholder="Select Status">
								...
								<option value="0" @if($grade->status == '0') selected @endif>Not Active </option>
							</select>
						</div>
					</div>
				</form>

    ...
    <div class="card card-{{ config('configs.app_theme') }} card-outline" id="attendance-preview">
      <div class="card-header">
        ...
        <div class="pull-right card-tools">
          <a href="{{ asset('import/Employee.xlsx') }}" class="btn btn-{{ config('configs.app_theme') }} text-white btn-sm" data-toggle="tooltip" title="Download Template">
      ...
      <div class="card-body">
        <form id="form" action="{{route('employees.storemass')}}">
        </form>

...
@section('title', 'Add Warning Letter')
@section('stylesheets')
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Position" id="title" name="title" readonly>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Join Date" id="join_date" name="join_date" readonly>
                    </div>
                  </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Number of Warning Letter" id="number_warning_letter" name="number_warning_letter" readonly>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>From</label>
                        <input type="text" class="form-control datepicker" placeholder="From" id="from" name="from" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>To</label>
                        <input type="text" class="form-control datepicker" placeholder="To" id="to" name="to" readonly>
                      </div>
                    </div>
                  </div>
              </div>

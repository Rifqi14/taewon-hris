          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Number of Warning Letter" id="number_warning_letter" name="number_warning_letter">
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>To</label>
                        <input type="text" class="form-control datepicker" placeholder="To" id="to" name="to">
                      </div>
                    </div>
                  </div>
              </div>

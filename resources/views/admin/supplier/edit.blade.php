...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" action="{{route('supplier.update',['id'=>$supplier->id])}}" class="form-horizontal" method="post" autocomplete="off">
               {{ csrf_field() }}
               ...
               <div class="well well-sm">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="{{$supplier->name}}" required>
                    </div>
                  </div>
                </div>
                <div class="well well-sm">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="phone" name="phone" placeholder="Telepon" value="{{$supplier->phone}}" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="email" class="col-sm-2 control-label">Email <b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                      <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{$supplier->email}}" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">Alamat <b class="text-danger">*</b></label>
                    <div class="col-sm-6">
                    <textarea name="address" id="address" class="form-control" required placeholder="Alamat">{{$supplier->address}}</textarea>
                      <div id="map"></div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Latitude" value="{{$supplier->latitude}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="name" class="col-sm-2 control-label">Longitude</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Longitude" value="{{$supplier->longitude}}">
                    </div>
                  </div>
                  <div class="form-group row">
                      <label for="app_logo" class="col-sm-2 control-label">Foto</label>
                      <div class="col-sm-6">
                      <input type="file" class="form-control" name="picture" id="picture" value={{$supplier->picture}}/>
                      </div>
                  </div>
                </div>
              </form>
  ...
  $(document).ready(function(){
    ...
    $( "#form textarea[name=address]" ).keyup(function() {
      ...
      browseClass: "btn btn-danger",
          ...
          initialPreview: '<img src="{{asset($supplier->picture)}}" class="kv-preview-data file-preview-image">',
          initialPreviewAsData: false,
          initialPreviewFileType: 'image',
          initialPreviewConfig: [
          {caption: "{{$supplier->picture}}", downloadUrl: "{{asset($supplier->picture)}}", size:"{{ @File::size(public_path($supplier->picture))}}",url: false}
          ],
          theme:'explorer-fas'
      });

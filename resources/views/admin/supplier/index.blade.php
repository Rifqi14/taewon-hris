        ...
        <div class="card ">
            <div class="card-header">
                ...
                <div class="pull-right card-tools">
                    <a href="{{route('supplier.create')}}" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" title="Tambah">
            ...
            { render: function ( data, type, row ) {
                return `<div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{url('admin/supplier')}}/${row.id}/edit"><i class="fa fa-pencil-alt mr-2"></i> Edit</a></li>

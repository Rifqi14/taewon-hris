            ...
            <div class="card ">
                <div class="card-header">
                    ...
                    <div class="pull-right card-tools">
                        <a href="{{route('truck.create')}}" class="btn btn-{{ config('configs.app_theme') }} btn-sm text-white" data-toggle="tooltip" title="Tambah">
            ...
            { 
                ...
                return `<div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{url('admin/truck')}}/${row.id}/edit"><i class="fas fa-pencil-alt mr-2"></i> Edit</a></li>

...
<div class="row">
    <div class="col-lg-12">
        <form id="form" action="{{route('oil.create')}}" class="form-horizontal" method="get" autocomplete="off">
            {{ csrf_field() }}
            ...
            <div class="card card-{{config('configs.app_theme')}} card-outline">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Oil Name <b
                                class="text-danger">*</b></label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Oil Name" required>
                        </div>
                    </div>

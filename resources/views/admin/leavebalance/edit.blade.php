...
<div class="row">
  <div class="col-lg-12">
    <div class="card card-{{ config('configs.app_theme') }} card-outline">
      ...
      <div class="card-body">
        <form id="form" action="{{ route('leavebalance.update',['id'=>$leavebalance->id]) }}" class="form-horizontal"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="leave_type" name="leave_type" placeholder="Leave Type"
                value="{{ $leavebalance->leave_type }}" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="balance" name="balance" placeholder="Amount per year"
                value="{{ $leavebalance->balance }}" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="leave_tag" name="leave_tag"
                placeholder="Leave tag, separated by comma (,)" value="{{ $leavebalance->leave_tag }}" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <div class="form-check form-check-inline">
                <input class="form-check-input i-checks" type="radio" name="description" id="description1"
                  value="Paid Leave" @if ($leavebalance->description == 'Paid Leave')
                checked @endif>
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input i-checks" type="radio" name="description" id="description2"
                  value="Unpaid Leave" @if ($leavebalance->description == 'Unpaid Leave')
                checked @endif>

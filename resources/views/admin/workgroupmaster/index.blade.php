					...
					<div class="row">
						{{-- <div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" name="code" class="form-control" placeholder="Workgroup Code">
							</div>
						</div> --}}
						<div class="col-md-12">
							<div class="form-group">
...
<script type="text/javascript">
  ...
  $(function(){
        ...
        if (row.can_edit == 0 && row.can_delete == 0) {
          return `<span class="badge badge-danger"><i class="fas fa-times"></i></span>`;
        } else if (row.can_edit == 1 && row.can_delete == 1) {
			...
			bootbox.confirm({
				...
				callback: function(result) {
					if(result) {
						...
						$.ajax({
							url: `{{url('admin/workgroupmaster')}}/${id}`,
							dataType: 'json',
							data:data,
							type:'DELETE',
							beforeSend:function(){

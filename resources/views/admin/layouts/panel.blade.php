...
<body class="sidebar-mini accent-{{config('configs.app_theme')}} text-sm layout-fixed dark">
    <div class="wrapper">
        <!-- Navbar -->
        ...
        <div class="content-wrapper">
            <section class="content p-0">
                <div class="background-dashboard">
                    <div class="col p-lg-5 p-sm-4">
                        <h4 class="text-white welcome-text mb-1 nunito">Welcome</h4>
                        <h6 class="text-white welcome-date nunito">{{ date('l, d F Y ') }}</h6>
                    </div>
                </div>

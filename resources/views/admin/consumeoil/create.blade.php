...
@push('breadcrump')
<li class="breadcrumb-item"><a href="{{route('department.index')}}">Consume Oil</a></li>
        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="stock" data-placeholder="Stock" name="stock" readonly>
                    </div>
                </div>
            </div>
            {{-- </div> --}}
            <div class="d-flex">
                <div class="col-sm-6">
                    ...
                    <input class="form-control engineoil" id="engine_oil" data-placeholder="Engine Oil" name="engine_oil">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label>Driver <b class="text-danger">*</b></label>
                   <input class="form-control" id="driver" data-placeholder="Driver" name="driver">
                </div>
              </div>
              <div class="col-sm-6">
                <!-- text input -->
                <div class="form-group">
                  <label>Type <b class="text-danger">*</b></label>
                   <select name="type" id="type" class="form-control select2" data-placeholder="Select Type">
                        <option value="Add Oil">Add Oil</option>
        ...
        <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>Notes</label>
                  <textarea style="width:310px; height:150px;" class="form-control" name="note" placeholder="Notes"></textarea>
                </div>
              </div>
            </div>
            <div class="row">

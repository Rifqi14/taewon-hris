    ...
    <div class="card">
        <div class="card-header">
          ...
          <div class="pull-right card-tools">
            <a href="{{route('province.create')}}" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" title="Tambah">
            ...
            { render: function ( data, type, row ) {
                return `<div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{url('admin/province')}}/${row.id}/edit"><i class="fa fa-edit"></i> Edit</a></li>

...
@section('title', __('attendanceapproved.atapprov'))
@section('stylesheets')
...
@push('breadcrump')
<li class="breadcrumb-item active">{{ __('attendanceapproved.atapprov') }}</li>
@endpush
...
<div class="wrapper wrapper-content">
      ...
      <div class="card card-{{ config('configs.app_theme') }} card-outline">
        <form id="form" action="{{ route('attendanceapproval.approve') }}" class="form-horizontal" method="post" autocomplete="off">
          ...
          <div class="card-header">
            <h3 class="card-title">{{ __('attendanceapproved.atapprov') }}</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="workgroup" id="workgroup" class="form-control" placeholder="{{ __('workgroupcombination.workcomb') }}">
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
            ...
            <table class="table table-striped table-bordered datatable" style="width: 100%">
              <thead>
                <tr>
                  ...
                  <th width="50">{{ __('attendanceapproved.scheme') }}</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button form="form-scheme" type="submit" class="btn btn-{{ config('configs.app_theme') }}" title="{{ __('general.save') }}"><i class="fa fa-save"></i></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="edit-in" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">{{ __('general.edt') }} First In</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="edit-out" tabindex="-1" role="dialog" aria-hidden="true" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">{{ __('general.edt') }} Last Out</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
...
<script type="text/javascript">
  ...
  $('#shift_workingtime').select2({
    allowClear:true,
  });
  $('#checkincheckout').select2({
    allowClear:true,
  });
  $(function() {

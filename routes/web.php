...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('/partner/import', 'Admin\PartnerController@import')->name('partner.import');
        Route::post('/partner/preview', 'Admin\PartnerController@preview')->name('partner.preview');
        Route::post('/partner/storemass', 'Admin\PartnerController@storemass')->name('partner.storemass');
        ...
        //Route Allowance Increase
        Route::get('/allowanceincrease/read', 'Admin\AllowanceIncreaseController@read')->name('allowanceincrease.read');
        ...
        Route::resource('/allowanceincrease','Admin\AllowanceIncreaseController');

        //Route Allowance Increase Detail
        ...
        // Route Overtime Allowance
        Route::get('/overtimeschemeallowance/read', 'Admin\OvertimeAllowanceController@read')->name('overtimeschemeallowance.read');
        Route::post('/overtimeschemeallowance/updateall', 'Admin\OvertimeAllowanceController@updateAll')->name('overtimeschemeallowance.updateall');
        Route::resource('/overtimeschemeallowance', 'Admin\OvertimeAllowanceController');
        // Route THR Report
